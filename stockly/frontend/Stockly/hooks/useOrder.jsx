...
const useOrder = (order_id = null) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (order_id) {
                const orderResponse = await axios.get(`${config.apiUrl}/orders/${order_id}`, {
    ...
    const handleAddItem = () => {
        ...
        setItems(prevItems => {
            ...
            const existingItemIndex = updatedItems.findIndex(item => item.product_id.toString() === selectedProduct.toString());
