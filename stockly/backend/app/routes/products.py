...
def register_product():
    ...
    if not name or not price or quantity is None or not isinstance(quantity, int): 
        return jsonify(message="Product name, price, and quantity are required. Quantity must be an integer."), 400
